...
OSG Software Cache Customers agree to:
   ...
   * Provide testing for the OSG Software Cache within the time frame defined in the [Requests for Service Enhancements](#requests-for-service-enhancements) section.
