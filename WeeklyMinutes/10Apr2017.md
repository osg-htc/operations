...
## Security
   ...
   * Pending announcement for VOMS-admin software package.
   * Koji website certificate showing errors due to bad certificate domain. The certificate has been issued for koji.chtc.wisc.edu
   * On April 11, 2017, there will be a minor code update for the CILogon Service. No downtime expected.
