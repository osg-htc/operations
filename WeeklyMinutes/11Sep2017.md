...
## Security
  * SiGNET CA? (Slovenia, seems to be gone)
  * The Apache Struts Group released Struts 2.5.13 on September 5th. This release fixes 3 security vulnerabilities, including a possible remote code execution attack when using the Struts REST plugin. 
  * Security training for RAs and GAs starting this week: Thursday September 14th, 10am CST.
