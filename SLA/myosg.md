...
| ---------------- | ------ | -------- | ---------- |
| [1.1](https://github.com/opensciencegrid/operations/blob/master/SLA/MyOSGServiceLevelAgreement?rev=2) | 5-26-2009 | Rob Quick | First Draft |
| [1.2](https://github.com/opensciencegrid/operations/blob/master/SLA/MyOSGServiceLevelAgreement?rev=7) | 9-10-2009 | Rob Quick | Second Draft |
...
## Software Services
Service Provider agrees to cover software support services, including software installations and upgrades. All software maintenance periods will be announced via the policy put forth in 
the [OSG Operations Responsibilities](#osg-operations-responsibilities) section of this document.
